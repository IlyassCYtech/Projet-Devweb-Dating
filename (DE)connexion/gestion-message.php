...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_POST["message"]) && !empty($_POST["message"]) && !empty($_POST["contact"])) {
        ...
        echo json_encode(array('success' => false, 'message' => 'Le champ de message est vide ou selestionner un destinataire'));
...
// Attendre 3 secondes avant de vérifier s'il y a de nouveaux messages
usleep(300000); // 3 secondes en microsecondes
...
$file = $directory;
    ...
    if ($file !== false) {
        ...
        error_log("[Messagerie PHP] Messages récupérés avec succès pour le contact : " . $contactemail);
    } else {
